...
onLoad(async (options) => {
  categoryId.value = options.categoryId ? Number.parseInt(options.categoryId, 10) : 2
  await fetchData()
})
...
<template>
  <view class="back-page" :class="{ 'back-page--locked': showAddModal || showDeleteModal }">
    <view class="bg-grid" />
    ...
    <view class="hero">
      <view class="hero-text">
        ...
        <text class="hero-title">背部</text>
        <text class="hero-subtitle">背阔肌 · 上中背 · 大小圆肌 · 下背部</text>
      </view>
...
.bg-glow--1 {
  width: 520rpx;
  height: 520rpx;
  background: rgba(124, 247, 212, 0.15);
  top: -220rpx;
  right: -180rpx;
}
...
.primary-btn {
  ...
  box-shadow: 0 18rpx 40rpx rgba(124, 247, 212, 0.3);
  transition:
...
.primary-btn:active {
  ...
  box-shadow: 0 12rpx 26rpx rgba(124, 247, 212, 0.2);
}
...
.section-count {
  ...
  border: 1rpx solid rgba(124, 247, 212, 0.35);
  display: flex;
  align-items: center;
...
.exercise-chip--selected {
  ...
  box-shadow: 0 4rpx 16rpx rgba(124, 247, 212, 0.1);
...
.modal-glow {
  ...
  top: -90rpx;
  border-radius: 50%;
  background: radial-gradient(circle, rgba(124, 247, 212, 0.35), transparent 70%);
  filter: blur(6rpx);
  opacity: 0.9;
  pointer-events: none;
  z-index: 0;
...
.modal-corner--tl {
  top: 10rpx;
  left: 10rpx;
  border-top-color: rgba(124, 247, 212, 0.75);
  border-left-color: rgba(124, 247, 212, 0.75);
...
.modal-corner--tr {
  top: 10rpx;
  right: 10rpx;
  border-top-color: rgba(139, 156, 255, 0.75);
  border-right-color: rgba(139, 156, 255, 0.75);
...
.modal-corner--bl {
  bottom: 10rpx;
  left: 10rpx;
  border-bottom-color: rgba(139, 156, 255, 0.6);
  border-left-color: rgba(139, 156, 255, 0.6);
...
.modal-corner--br {
  ...
  border-right-color: rgba(124, 247, 212, 0.6);
...
.modal-title::after {
  ...
  height: 4rpx;
  border-radius: 999rpx;
  background: linear-gradient(90deg, rgba(124, 247, 212, 0.9), rgba(139, 156, 255, 0.8));
}
...
.modal-input:focus {
  ...
  box-shadow: 0 0 0 2rpx rgba(124, 247, 212, 0.15);
}
